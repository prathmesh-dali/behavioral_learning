...
model.fit_generator(generator_images(training_data), samples_per_epoch = len(training_data)*4, nb_epoch = 1, validation_data=generator_images(validatio_data), nb_val_samples=len(validatio_data))
